...
CREATE INDEX IF NOT EXISTS idx_contents_short_id   ON contents(short_id);
...
CREATE INDEX IF NOT EXISTS idx_video_variants_content_id ON video_variants(content_id);
