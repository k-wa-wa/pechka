...
- **目的**: 全文検索。
- **処理**: Elasticsearch と MongoDB を組み合わせた検索エンジンを使用する。詳細は [014_service_search_design.md](file:///Users/watanabekouhei/workspace/pechka/stream/docs/014_service_search_design.md) を参照。
